...
export default function BorrowStatus() {
  ...
  useEffect(() => {
    const fetchBorrowRequests = async () => {
      ...
      try {
        const response = await fetch(`https://crmcpropertycusbacck-ffgphsd2aveqdxen.southeastasia-01.azurewebsites.net/api/BorrowRequestApi/RequestById/${borrowerId}`)
  ...
  const fetchBorrowItems = async (borrowId) => {
    ...
    try {
      const response = await fetch(`https://crmcpropertycusbacck-ffgphsd2aveqdxen.southeastasia-01.azurewebsites.net/api/BorrowRequestApi/ViewRequest/${borrowId}`)
      if (!response.ok) {
  ...
  const cancelRequest = async () => {
    ...
    setCanceling(true)
    try {
      const response = await fetch("https://crmcpropertycusbacck-ffgphsd2aveqdxen.southeastasia-01.azurewebsites.net/api/BorrowRequestApi/CancelRequest", {
        method: "POST",
        headers: {
